...
export const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile menu - properly centered overlay */}
      {isMenuOpen && (
        <div 
        ...
        >
          ...
          >
            <div className="bg-background/95 backdrop-blur-xl rounded-2xl shadow-xl border border-primary/20 py-6 px-5">
              {/* Close button */}
                ...
                {navItems.map((item, key) => {
                  ...
                  return (
                    <a 
                      ...
                      href={item.href} 
                      className={cn(
                        "relative px-6 py-3 rounded-lg text-center transition-all duration-300",
